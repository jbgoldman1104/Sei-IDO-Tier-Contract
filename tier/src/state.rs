...
pub const WITHDRAWALS_LIST: Item<Vec<UserWithdrawal>> = Item::new("new");//Deque<UserWithdrawal> = Deque::new("withdraw");
...
impl Config {
    ...
    pub fn to_answer<A: Api>(&self, api: &A) -> StdResult<QueryResponse> {
