...
use crate::msg::{ExecuteMsg, ExecuteResponse, QueryResponse, InstantiateMsg, QueryMsg, ContractStatus, ResponseStatus};
...
pub fn try_withdraw(
    ...
    let mut withdrawals = WITHDRAWALS_LIST.load(deps.storage)?;
    withdrawals.push(withdrawal);
    WITHDRAWALS_LIST.save(deps.storage, &withdrawals);
